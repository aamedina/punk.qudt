...
(def ^{:private true} GMD_QUDT-PREFIXES
  "Prefixes Vocabulary Version 2.1 Metadata"
  {:db/ident :vaem/GMD_QUDT-PREFIXES,
   :dcterms/contributor ["Ralph Hodgson" "Jack Hodges" "Steve Ray"],
   :dcterms/created #inst "2020-07-15T00:00:00.000-04:00",
   :dcterms/creator "Steve Ray",
   :dcterms/modified #inst "2023-01-13T22:11:40.388-00:00",
   :dcterms/rights
   ...
   "https://qudt.org/doc/2022/12/DOC_VOCAB-PREFIXES-v2.1.html",
   :vaem/revision "2.1",
   :vaem/specificity 1,
   :vaem/turtleFileURL "http://qudt.org/2.1/vocab/prefix",
   :vaem/urlForHTML "http://qudt.org/2.1/vocab/prefix.html",
   :vaem/usesNonImportedResource [:dcterms/title
                                  :dcterms/abstract
                                  :dcterms/created
                                  :dcterms/creator
                                  :dcterms/modified],
   :vaem/website "http://qudt.org/2.1/vocab/prefix.ttl"})