...
(def ^{:private true} GMD_QUDT-DIMENSION-VECTORS
  "Provides the set of all dimension vectors"
  {:db/ident :vaem/GMD_QUDT-DIMENSION-VECTORS,
   :dcterms/contributor ["Steve Ray" "Jack Hodges"],
   :dcterms/created #inst "2019-08-01T16:25:54.850-00:00",
   :dcterms/creator "Steve Ray",
   :dcterms/description "Provides the set of all dimension vectors",
   :dcterms/modified #inst "2023-01-13T21:55:50.301-00:00",
   :dcterms/rights
   ...
   :rdfs/isDefinedBy "http://qudt.org/2.1/vocab/dimensionvector",
   :rdfs/label "QUDT Dimension Vector Vocabulary Version 2.1.24",
   :vaem/applicableDiscipline "All disciplines",
   :vaem/applicableDomain "Science, Medicine and Engineering",
   :vaem/dateCreated #inst "2019-08-02T01:26:38.000-00:00",
   :vaem/description
   ...
   :vaem/graphTitle "QUDT Dimension Vectors Version 2.1.24",
   ...
   "https://qudt.org/doc/2023/01/DOC_VOCAB-QUANTITY-KIND-DIMENSION-VECTORS-v2.1.html",
   :vaem/logo
   ...
   "https://qudt.org/doc/2022/12/DOC_VOCAB-QUANTITY-KIND-DIMENSION-VECTORS-v2.1.html",
   :vaem/revision "2.1",
   :vaem/specificity 1,
   :vaem/turtleFileURL "http://qudt.org/2.1/vocab/dimensionvector",
   :vaem/usesNonImportedResource [:dc11/subject
                                  :dcterms/rights
                                  :dcterms/contributor
                                  :dc11/contributor
                                  :dcterms/modified
...
(def ^{:private true} QUDT-DIMENSIONS-VocabCatalogEntry
  "QUDT DIMENSIONS Vocab Catalog Entry"
  {:db/ident         :voag/QUDT-DIMENSIONS-VocabCatalogEntry,
