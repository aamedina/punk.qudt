...
(def SI
  ...
  {:db/ident :sou/SI,
   ...
   :qudt/prefix ["http://qudt.org/2.1/vocab/prefix/Nano"
                 "http://qudt.org/2.1/vocab/prefix/Giga"
                 "http://qudt.org/2.1/vocab/prefix/Tera"
                 "http://qudt.org/2.1/vocab/prefix/Femto"
                 "http://qudt.org/2.1/vocab/prefix/Pico"
                 "http://qudt.org/2.1/vocab/prefix/Yocto"
                 "http://qudt.org/2.1/vocab/prefix/Deca"
                 "http://qudt.org/2.1/vocab/prefix/Atto"
                 "http://qudt.org/2.1/vocab/prefix/Deci"
                 "http://qudt.org/2.1/vocab/prefix/Kilo"
                 "http://qudt.org/2.1/vocab/prefix/Milli"
                 "http://qudt.org/2.1/vocab/prefix/Micro"
                 "http://qudt.org/2.1/vocab/prefix/Mega"
                 "http://qudt.org/2.1/vocab/prefix/Zetta"
                 "http://qudt.org/2.1/vocab/prefix/Centi"
                 "http://qudt.org/2.1/vocab/prefix/Yotta"
                 "http://qudt.org/2.1/vocab/prefix/Exa"
                 "http://qudt.org/2.1/vocab/prefix/Peta"
                 "http://qudt.org/2.1/vocab/prefix/Zepto"
                 "http://qudt.org/2.1/vocab/prefix/Hecto"],
   :rdf/type :qudt/SystemOfUnits,
   :rdfs/isDefinedBy "http://qudt.org/2.1/vocab/sou",
   :rdfs/label {:rdf/language "en",
...
(def SOU_ASU
  ...
  {:db/ident       :sou/SOU_ASU,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/sou/ASU"]})
...
(def SOU_IMPERIAL
  ...
  {:db/ident       :sou/SOU_IMPERIAL,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/sou/IMPERIAL"]})
...
(def SOU_PLANCK
  ...
  {:db/ident       :sou/SOU_PLANCK,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/sou/PLANCK"]})
...
(def SOU_SI
  ...
  {:db/ident       :sou/SOU_SI,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/sou/SI"]})
...
(def SOU_USCS
  ...
  {:db/ident       :sou/SOU_USCS,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/sou/USCS"]})
...
(def ^{:private true} GMD_QUDT-SOU
  "QUDT Systems of Units Vocabulary Version 2.1.24"
  {:db/ident :vaem/GMD_QUDT-SOU,
   :dcterms/contributor ["Steve Ray" "Jack Hodges"],
   :dcterms/created #inst "2016-07-04T00:00:00.000-04:00",
   :dcterms/creator "Ralph Hodgson",
   :dcterms/description "QUDT Systems of Units Vocabulary Version 2.1.24",
   :dcterms/modified #inst "2023-01-13T22:12:40.983-00:00",
   :dcterms/rights
   ...
   :dcterms/title "QUDT Systems of Units Ontology Version 2.1.24",
   :owl/versionIRI "http://qudt.org/2.1/vocab/sou",
   :rdf/type :vaem/GraphMetaData,
   :rdfs/isDefinedBy "http://qudt.org/2.1/vocab/sou",
   :rdfs/label "QUDT Systems of Units Ontology Version 2.1.24",
   :vaem/graphTitle "Systems of Units Ontology Version 2.1.24",
   :vaem/hasGraphRole :vaem/VocabularyGraph,
   :vaem/hasOwner :vaem/QUDT,
   :vaem/hasSteward :vaem/QUDT,
   :vaem/intent
   "The intent of this graph is the specification of all Systems of Units",
   :vaem/isMetadataFor "http://qudt.org/2.1/vocab/sou",
   :vaem/latestPublishedVersion
   "https://qudt.org/doc/2023/01/DOC_VOCAB-SYSTEMS-OF-UNITS-v2.1.html",
   :vaem/logo
   ...
   "https://qudt.org/doc/2022/12/DOC_VOCAB-SYSTEMS-OF-UNITS-v2.1.html",
   :vaem/revision "2.1",
   :vaem/turtleFileURL "http://qudt.org/2.1/vocab/sou",
   :vaem/usesNonImportedResource [:prov/wasInformedBy :prov/wasInfluencedBy]})