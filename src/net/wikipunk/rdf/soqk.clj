...
(def SI
  ...
  {:db/ident          :soqk/SI,
   :qudt/dbpediaMatch :dbr/International_System_of_UnitsX,
...
(def SOQK_CGS
  ...
  {:db/ident       :soqk/SOQK_CGS,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/soqk/CGS"]})
...
(def SOQK_CGS-EMU
  ...
  {:db/ident       :soqk/SOQK_CGS-EMU,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/soqk/CGS-EMU"]})
...
(def SOQK_CGS-ESU
  ...
  {:db/ident       :soqk/SOQK_CGS-ESU,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/soqk/CGS-ESU"]})
...
(def SOQK_CGS-Gauss
  ...
  {:db/ident       :soqk/SOQK_CGS-Gauss,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/soqk/CGS-Gauss"]})
...
(def SOQK_IMPERIAL
  ...
  {:db/ident       :soqk/SOQK_IMPERIAL,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/soqk/IMPERIAL"]})
...
(def SOQK_ISQ
  ...
  {:db/ident       :soqk/SOQK_ISQ,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/soqk/ISQ"]})
...
(def SOQK_Planck
  ...
  {:db/ident       :soqk/SOQK_Planck,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/soqk/Planck"]})
...
(def SOQK_SI
  ...
  {:db/ident       :soqk/SOQK_SI,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/soqk/SI"]})
...
(def SOQK_USCS
  ...
  {:db/ident       :soqk/SOQK_USCS,
   ...
   :rdfs/seeAlso   ["http://qudt.org/vocab/soqk/USCS"]})
...
(def ^{:private true} GMD_QUDT-SOQK
  "QUDT Systems of Quantity Kinds Vocabulary Version 2.1.24"
  {:db/ident :vaem/GMD_QUDT-SOQK,
   :dcterms/contributor ["Steve Ray" "Jack Hodges"],
   :dcterms/created #inst "2016-07-04T00:00:00.000-04:00",
   :dcterms/creator "Ralph Hodgson",
   :dcterms/description
   "QUDT Systems of Quantity Kinds Vocabulary Version 2.1.24",
   :dcterms/modified #inst "2023-01-13T22:13:59.482-00:00",
   :dcterms/rights
   ...
   :dcterms/title "QUDT Systems of Quantity Kinds Ontology Version 2.1.24",
   :owl/versionIRI "http://qudt.org/2.1/vocab/soqk",
   :rdf/type :vaem/GraphMetaData,
   :rdfs/isDefinedBy "http://qudt.org/2.1/vocab/soqk",
   :rdfs/label "QUDT Systems of Quantity Kinds Ontology Version 2.1.24",
   :vaem/graphTitle "Systems of Quantity Kinds Ontology Version 2.1.24",
   :vaem/hasGraphRole :vaem/VocabularyGraph,
   :vaem/hasOwner :vaem/QUDT,
   :vaem/hasSteward :vaem/QUDT,
   :vaem/intent
   "The intent of this graph is the specification of all Systems of Quantity Kinds",
   :vaem/isMetadataFor "http://qudt.org/2.1/vocab/soqk",
   :vaem/latestPublishedVersion
   "https://qudt.org/doc/2023/01/DOC_VOCAB-SYSTEMS-OF-QUANTITY-KINDS-v2.1.html",
   :vaem/logo
   ...
   "https://qudt.org/doc/2022/12/DOC_VOCAB-SYSTEMS-OF-QUANTITY-KINDS-v2.1.html",
   :vaem/revision "2.1",
   :vaem/turtleFileURL "http://qudt.org/2.1/vocab/soqk",
